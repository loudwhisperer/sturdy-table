...
const eventEl = [
  {
    ...
    notes:
      "Hosting up to two games depending on attendance. Typical length is 2 hours. BYOB!",
    host_id: 15,
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec turpis nec quam congue imperdiet a et purus. Morbi felis eros, aliquam in rhoncus non, tempor sit amet massa. Cras et molestie turpis. In dictum imperdiet turpis quis imperdiet.",
  ...
  },
  {
    ...
    description:
      "Embark on a quest to settle the fair isle of Catan! Guide your brave settlers to victory by using clever trading and development.Use resources (grain, wool, ore, brick, and lumber) to build roads, settlements, and cities, and buy development cards.",
  ...
  },
  {
    ...
    game_name: "Monopoly",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec turpis nec quam congue imperdiet a et purus. Morbi felis eros, aliquam in rhoncus non, tempor sit amet massa.",
    notes:
      "Get ready to wreck our friendship in this extremely competetive game of Monopoly",
    host_id: 9,
  },
  {
    ...
    description:
      "The game is set in the grim darkness of the far future, where mighty armies clash on countless war-torn worlds and Humanity stands alone, beset on all sides by the threats of the heretic, the mutant and the alien. There is no mercy.",
  ...
  },
  {
    ...
    description:
      "Players form an adventuring party who explore cyber fantasy worlds together as they embark on epic quests and level up in experience",
  ...
  },
  {
    ...
    game_name: "Dune",
    description:
      "Players become the leader of one of six great factions. Each wishes to control the most valuable resource in the universe - Melange",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec turpis nec quam congue imperdiet a et purus. Morbi felis eros, aliquam in rhoncus non, tempor sit amet massa. Cras et molestie turpis. In dictum imperdiet turpis quis imperdiet.",
    notes:
      "Couple of late night games to get ready for the murder mystery movie. Popcorn supplied!",
    host_id: 9,
  },
  {
  ...
  },
  {
    ...
    game_name: "Chess",
    description:
      "Represents medieval warfare on an 8x8 board with alternating light and dark squares.",
  ...
  },
  {
    ...
    description:
      "The defining feature of Machiavelli is being able to make changes to the combinations of cards already on the table.",
    notes:
      "Weekly game night, learning a new card game this week. Always up to switching, also.",
    host_id: 16,
  },
  {
    name: "Duelists!?",
    ...
    description:
      "Players acquire cards that provide resources or advance their military or scientific development in order to develop a civilization and complete wonders.",
  ...
  },
  {
    ...
    notes:
      "Looking for someone to play this new game with me that I haven't tried.",
    host_id: 13,
  },
  {
    ...
    description:
      "Players act as heroes trying to defeat mythological monsters. Unlike many other cooperative games, players cannot see each others cards.",
    notes:
      "Just looking to play some casual games with the friends. Bring what you want!",
    host_id: 14,
  },
  {
  ...
  },
  {
    ...
    description:
      "Party game released for the Nintendo GameCube. Mario and the gang, using the MSS Sea Star, go vacationing to locations based on landmarks on Earth. However, Bowser is not invited on the cruise and decides to cause trouble for Mario and his friends.",
    notes:
      "We have 3 set ups that can allow up to 4 players on each. Controller required to play. Bring your A Game.",
    host_id: 16,
  },
  {
    ...
    description:
      "Players compete in an exciting race to build the largest and most advanced railway network. In order to do so, the players appoint their workers to various important tasks.",
